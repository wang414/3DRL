    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                if self.num_timesteps < self.warmup_step:
    ...
    def set_parameters_policy(
        ...
        for name in params:
            ...
            if isinstance(attr, th.optim.Optimizer):
                ...
                if name == 'policy':
                    kw = ['lstm_critic', 'value_net']
                    keys_to_pop = [key for key in params[name].keys() if any(keyword in key for keyword in kw)]
